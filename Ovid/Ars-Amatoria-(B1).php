<html>
	<head>
		<title>Ovid: Ars Amatoria Übersetzung (Buch I) | Lateinparadies</title>
								...
								<div class="nav">
									...
									<ul>
										<font size="4">
											...
											<span class="spc"><li>>></li></span>
											<li><a href="">Ars Amatoria (Buch I)</a></li>
						...
						<tr>
							<td background="../images/color_blue.png" style="text-align: center">
								...
								<font size="7" color="#F2F2F2">
									<u>Ovid: Ars Amatoria</u>
								</font>
								<div class="idReferrer">
									<ul>
										<font size="3">
												<li><a href="#Vers1-60">1-60</a></li>
												<li><a href="#Vers80-170">80-170</a></li>
												<li><a href="#Vers230-250">230-250</a></li>
												<li><a href="#Vers475-485">475-485</a></li>
										</font>
									</ul>
								</div>
								<br><br><br>
						...
						<tr>
							<td>
								<table style="width: 100%">
									<tr>
										<td>
											<table class="trlPoem" id="Headline">
												<tr>
													<td></td>
													<td style="background-image: url(../images/color_blue.png)"></td>
													<td>
														<font size="6" color="#FFCC00"><u>Latein:</u></font>
														<br><br>
													</td>
													<td style="background-image: url(../images/color_blue.png)"></td>
													<td>
														<font size="6" color="#FFCC00"><u>Deutsch:</u></font>
														<br><br>
													</td>
												</tr>
											</table>
									...
									<tr>
										<td>
											<table class="trlPoem" id="Vers1-60">
												<tr>
													<td>
									...
									<tr>
										<td>
											<table class="trlPoem" id="Vers80-170">
												<tr>
													<td>
														<font size="4" color="#FF9900">
															<br>
									...
									<tr>
										<td>
											<table class="trlPoem" id="Vers230-250">
												<tr>
													<td>
														<font size="4" color="#FF9900">
															<br>
									...
									<tr>
										<td>
											<table class="trlPoem" id="Vers475-485">
												<tr>
													<td>
														<font size="4" color="#FF9900">
															<br>
						...
						<tr>
							<td class="credits" background="../images/color_blue.png">
								<font size="4" color="#CCCCCC">
									<br>
									Quelle des lateinischen Textes: <a target="_blank" href="http://www.thelatinlibrary.com/ovid/ovid.artis1.shtml">TheLatinLibrary</a></div>
									<br>
									...
									<td>
										<font size="3" color="#CCCCCC">
											<div style="padding: 0px 20px 0px 20px">Besuche dieser Seite:<br>
												<a href="https://www.webfreecounter.com/" target="_blank"><img src="https://www.webfreecounter.com/hit.php?id=zmnnkc&nd=9&style=44" alt="visitor counter"></a>
											</div>
											</font>
										</td>
									</tr>
