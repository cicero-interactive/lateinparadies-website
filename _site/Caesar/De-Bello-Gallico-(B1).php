...
<html>
	<head>
		<title>
				...
				Cäsar&#58; De Bello Gallico Übersetzung (Buch I) | Lateinparadies
...
<nav>
	...
	<ul>
		<li><a href="/">Home</a></li>
			...
			<li>
				<a href="/Caesar/De-Bello-Gallico-(B1).php">De Bello Gallico (Buch I)</a>
			</li>
...
<div class="idReferrer">
	<ul>
			...
			<li><a href="#Ch6">6</a></li>
		
			

			<li><a href="#Ch7">7</a></li>
		
			

			<li><a href="#Ch8">8</a></li>
		
			

			<li><a href="#Ch9">9</a></li>
			...
			<div id="Ch10" class="chapter">
				...
				<h2>Kapitel 10</h2>
					...
					<div class="chapter-item">
						...
						<div></div>
						<p>
							Cäsar wurde gemeldet, dass die Helvetier vorhätten, durch das Gebiet der Sequaner und Häduer ins Gebiet der Santoner zu ziehen. Diese sind nicht weit vom Gebiet der Tolosaten entfernt, ein Volk in unserer Provinz. Cäsar sah ein, dass es, wenn dies geschehe, mit großer Gefahr für die Provinz verbunden sein würde, wenn diese ein kriegerisches Volk mit offenem und sehr getreidereichem Gebiet als Nachbarn hätte. Deswegen stellte er die Befestigung, die er hatte anlegen lassen, unter den Befehl des Legaten<sup>1</sup> Titus Labienus. Er selbst eilte so schnell wie möglich nach Italien, hob zwei Legionen aus, führte die drei Legionen, die bei Aquileja überwintern, aus dem Winterlager heraus und beeilte sich, wo der nächste Weg ins jenseitige Gallien über die Alpen führte, mit diesen fünf Legionen zurückzukehren. Dort versuchten die Ceutronen, Grajoceler und Caturigen nach Besetzung der beherrschenden Anhöhen das Heer am Weitermarsch zu hindern. Nachdem diese in mehreren Gemetzeln geschlagen worden sind, gelangte Cäsar von Ocelum, welches die außerste Stadt der diesseitigen Provinz ist, in das Gebiet der Vocontier in der jenseitigen Provinz in sieben Tagen. Von dort führte er sein Heer ins Gebiet der Allobroger, dann vom Gebiet der Allobroger ins Gebiet der Segusiaver. Diese sind die ersten außerhalb der Provinz jenseits der Rhone.
							
								<br><br>
								<span class="footnotes">
									
										<sup>1</sup>: Legat = Stellvertreter und militärischer Befehlshaber (siehe <a href="https://de.wikipedia.org/wiki/Legatus" target="_blank">hier</a>)<br>
			...
			<div id="Ch22" class="chapter">
				...
				<h2>Kapitel 22</h2>
					...
					<div class="chapter-item">
						...
						<div></div>
						<p>
							Bei Tagesanbruch, als der Gipfel des Berges von Labienus besetzt wurde und Cäsar selbst vom Lager der Feinde nicht weiter als 1500 Doppelschritte<sup>1</sup> entfernt war, sind weder seine eigene Ankunft noch die des Labienus bemerkt worden, wie er später von Kriegsgefangenen erfuhr. Auf einem Pferd sprengte Considius in vollem Galopp zu ihm und meldete, dass der Berg, den Cäsar einnehmen wollte, von den Galliern besetzt werde: Das hätte er an den gallischen Waffen und Feldzeichen erkannt<sup>2</sup>. [...]
							
								<br><br>
								<span class="footnotes">
									
										<sup>1</sup>: 1.500 Passus (Doppelfuß) ~ 2220m<br>
									
										<sup>2</sup>: Zeichen der Unwissenheit Considius'&#58; Die Feldzeichen gehörten den helvetischen Hilfstruppen, die Cäsar angefordert hatte.<br>
...
<div class="translation-sources">
    Quelle des lateinischen Textes:
        ...
        <a target="_blank" href="http://www.thelatinlibrary.com/caesar/gall1.shtml">
	...
	<div>
		...
		<a href="https://www.webfreecounter.com/" target="_blank"><img src="https://www.webfreecounter.com/hit.php?id=zuexnax&nd=9&style=44" alt="hit counter"></a>
	</div>
