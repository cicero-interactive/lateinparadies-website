...
<html>
	<head>
		<title>
				...
				Cäsar&#58; De Bello Gallico Übersetzung (Buch VI) | Lateinparadies
...
<nav>
	...
	<ul>
		<li><a href="/">Home</a></li>
			...
			<li>
				<a href="/Caesar/De-Bello-Gallico-(B6).php">De Bello Gallico (Buch VI)</a>
			</li>
			...
			<div id="Ch24" class="chapter">
				...
				<h2>Kapitel 24</h2>
					...
					<div class="chapter-item">
						...
						<div></div>
						<p>
							Früher gab es eine Zeit, als die Gallier die Germanen an Tapferkeit übertrafen, aus freien Stücken Kriege <span class="annotation">[gegen sie]</span> begannen und wegen der großen Zahl an Menschen <span class="annotation">(überbevölkerung)</span> und des Mangels an Ackerland Siedler über den Rhein schickten. Und so besetzten die Tektosagen, ein Stamm der Volker, die Orte, die die fruchtbarsten Germaniens um den Herkynischen Wald herum sind, der, wie ich sehe, schon Eratosthenes und gewissen <span class="annotation">[anderen]</span> Griechen unter dem Namen Orkynischer Wald durch Hörensagen bekannt war, und ließen sich dort nieder. Dieser Stamm erhält sich bis zu dieser Zeit an diesen Sitzen und hat den höchsten Ruf von Gerechtigkeit und Kriegsruhm. Die Germanen benutzen jetzt <span class="annotation">[immer noch]</span> dieselbe Lebensweise und Körperpflege, da sie ja auf demselben Mangel und derselben Dürftigkeit und Genügsamkeit verharren. Den Galliern aber verschafft die Nähe römischer Provinzen und die Bekanntschaft mit den über das Meer kommenden Waren mehr zum eigenen Wohlstand und Luxus. Allmählich sind sie daran gewöhnt besiegt zu werden und vergleichen sich nach vielen Niederlagen nicht einmal mehr selbst an Tapferkeit mit den Germanen.
			...
			<div id="Ch26" class="chapter">
				...
				<h2>Kapitel 26</h2>
					...
					<div class="chapter-item">
						...
						<div></div>
						<p>
							Es gibt ein Rind mit der Gestalt eines Hirschen<sup>1</sup>. Mitten von dessen Stirn tritt zwischen den Ohren ein einziges Horn hervor, das höher und gerader ist als die uns bekannten Hirschgeweihe. Von dessen Spitze breitet sich das Horn aus, wie sich Hände oder Zweige weit ausbreiten.  Das Wesen des Weibchens und des das des Männchens ist dasselbe, ebenso die Gestalt und Größe des Geweihes.
							
								<br><br>
								<span class="footnotes">
									
										<sup>1</sup>: Gemeint ist hier das Rentier<br>
...
<div class="translation-sources">
    Quelle des lateinischen Textes:
        ...
        <a target="_blank" href="http://www.thelatinlibrary.com/caesar/gall6.shtml">
