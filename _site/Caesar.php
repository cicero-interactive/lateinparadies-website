...
<html>
	<head>
		<title>
				...
				Cäsar Übersetzungen | Lateinparadies
...
<nav>
	...
	<div class="big4">
		...
		Wähle den gewünschten Cäsar-Text:
...
<div class="sectionLinksTranslation">
	<ul>
					...
					<li style="width: 60%"><a href="/Caesar/De-Bello-Gallico-(B1).php">De Bello Gallico (Buch I)</a></li>
					...
					<li style="width: 60%"><a href="/Caesar/De-Bello-Gallico-(B6).php">De Bello Gallico (Buch VI)</a></li>
	...
	<div>
		...
		<a href="https://www.webfreecounter.com/" target="_blank"><img src="https://www.webfreecounter.com/hit.php?id=zmuemxnkc&nd=9&style=44" alt="hit counter"></a>
	</div>
