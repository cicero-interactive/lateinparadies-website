<html>
	<head>
		<title>Ovid: Ars Amatoria Übersetzung (Buch II) | Lateinparadies</title>
								...
								<div class="nav">
									...
									<ul>
										<font size="4">
											...
											<span class="spc"><li>>></li></span>
											<li><a href="">Ars Amatoria (Buch II)</a></li>
									...
									<tr>
										<td>
											<table class="trlPoem" id="Headline">
												<tr>
													<td></td>
													<td style="background-image: url(../{{ site.baseurl }}/assets/img/color_blue.png)"></td>
													<td>
									...
									<td>
										<font size="3" color="#CCCCCC">
											<div style="padding: 0px 20px 0px 20px">Besuche dieser Seite:<br>
												<a href="https://www.webfreecounter.com/" target="_blank"><img src="https://www.webfreecounter.com/hit.php?id=zrexocd&nd=9&style=44" alt="free counter"></a>
											</div>
											</font>
										</td>
									</tr>
