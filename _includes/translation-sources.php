<div class="translation-sources">
    ...
    <br>
    Fehler gefunden? Melde ihn bitte auf <a href="{{ site.github-issues }}" target="_blank">GitHub</a> oder kontaktiere uns unter unserer <a href="mailto:{{ site.email }}">E-Mail-Adresse</a>!
</div>
